...
func (s *styleguide) PageDetails(ctx context.Context, request operations.PageDetailsRequest) (*operations.PageDetailsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/styleguide/page/{pageId}", request.PathParams)
