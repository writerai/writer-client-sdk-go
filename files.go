...
func (s *files) DeleteFile(ctx context.Context, request operations.DeleteFileRequest) (*operations.DeleteFileResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/llm/organization/{organizationId}/file/{fileId}", request.PathParams)
...
// Files - List files
func (s *files) Files(ctx context.Context, request operations.FilesRequest) (*operations.FilesResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/llm/organization/{organizationId}/file", request.PathParams)
